...
def products_list(request):
    ...
    products = products.filter(
        Q(title__icontains=search_value) | Q(description__icontains=search_value)) if search_value else products
...
def rate_product(request, pk):
    ...
    form = forms.RateForm()
    return render(request, 'rate_product.html', {'form': form, 'product': product, 'reviews': reviews})
